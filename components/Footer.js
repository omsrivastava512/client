  ...
  <div className="bg-gray-200 container px-5 py-24 mx-auto" style={{}}>
    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
        ...
        <nav className="list-none mb-10">
          ...
          <li className="email-link">
            ...
            <div className="leading-relaxed text-gray-600">
              <i className="fas fa-map-marker-alt" aria-hidden="true" /> 39,
              Sector Rd Block D, South City I,
              <br />
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            {" "}
            <a
              href="/submitticket?step=2&deptid=1"
              className="text-gray-600 hover:text-gray-800"
            >
              {" "}
              Open a Ticket
          ...
          <li>
            {" "}
            <a
              href="/submitticket?step=2&deptid=2"
              className="text-gray-600 hover:text-gray-800"
            >
              {" "}
              Report a Abuse
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <i className="fab fa-cc-visa" style={{ fontSize: 28, color: "grey" }} />{" "}
        <i className="fab fa-cc-amex" style={{ fontSize: 28, color: "grey" }} />{" "}
        <i
  ...
  <div className="bg-gray-300">
    ...
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p className="text-sm text-gray-600 sm:ml-6 sm:mt-0 mt-4">
        ...
        <a href="" rel="noopener noreferrer" className="text-gray-600 ml-1">
          {" "}
          All Rights Reserved.
        </a>
      </p>
