  ...
  <div style={{ backgroundColor: "rgb(255, 255, 255)" }}>
    ...
    >
      <div className="max-w-lg mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-none lg:flex">
        <div
          className="flex-1 px-6 py-8 bg-white lg:p-12"
          style={{ cursor: "auto" }}
        >
          <h3
          ...
          <div className="mt-8">
            ...
            <ul className="mt-8 space-y-5 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-5">
              ...
              <li className="flex items-start lg:col-span-1">
                ...
                <p className="ml-3 text-sm text-gray-700">
                  8x 3,6 Ghz, Turbo 4,4 Ghz, 32MB Cache 
                </p>
              </li>
              <li className="flex items-start lg:col-span-1">
                <div className="flex-shrink-0">
                ...
                <p className="ml-3 text-sm text-gray-700">Softraid 0/1</p>
              </li>
              <li className="flex items-start lg:col-span-1">
                <div className="flex-shrink-0">
                  <svg
                ...
                <p className="ml-3 text-sm text-gray-700">
                  2x 1 TB M.2 NVMe SSD + 2x 10 TB SATA HDD
                </p>
              </li>
              <li className="flex items-start lg:col-span-1">
                <div className="flex-shrink-0">
                ...
                <p className="ml-3 text-sm text-gray-700">1 x 1 GbE</p>
              </li>
            </ul>
          </div>
        </div>
        <div
          className="px-6 py-8 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12"
          style={{ cursor: "auto" }}
        >
          <p
